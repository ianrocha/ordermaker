...
DEFAULT_FILE_STORAGE = 'ordermaker.aws.utils.MediaRootS3BotoStorage'
STATICFILES_STORAGE = 'ordermaker.aws.utils.StaticRootS3BotoStorage'
AWS_STORAGE_BUCKET_NAME = 'order-maker'
